    ...
    ;(function () {
        ...
        class App {
            ...
            updatePrivacyAgreementVisibility() {
                ...
                // 3. Privacy Policy Consent Banner (for signed-in users who haven't accepted yet)
                // We use a non-blocking bottom banner instead of a full-screen modal to improve UX
                if (isSignedIn && !acceptedAt) {
                    // Show the banner container
                    this.dom.consentModal?.classList.remove('hidden');
                    
                    // Trigger the slide-in animation in the next animation frame to ensure the transition is visible
                    ...
                    // Wait for the 300ms transition to finish before hiding the element completely
                    setTimeout(() => {
...
waitForDOM();
  ...
  return (
    ...
    {/* Privacy Policy Consent Banner - Redesigned to be non-blocking and mobile-friendly */}
